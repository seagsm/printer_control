...
#define IS_TIM_IT(IT) ((((IT) & (uint16_t)0xFF00) == 0x0000U) && ((IT) != 0x0000U))
...
#define IS_TIM_DMA_SOURCE(SOURCE) ((((SOURCE) & (uint16_t)0x80FF) == 0x0000U) && ((SOURCE) != 0x0000U))
...
#define IS_TIM_EVENT_SOURCE(SOURCE) ((((SOURCE) & (uint16_t)0xFF00) == 0x0000U) && ((SOURCE) != 0x0000U))
...
#define IS_TIM_CLEAR_FLAG(TIM_FLAG) ((((TIM_FLAG) & (uint16_t)0xE100) == 0x0000U) && ((TIM_FLAG) != 0x0000U))
/**
  * @}
  */
...
#define IS_TIM_EXT_FILTER(EXTFILTER) ((EXTFILTER) <= 0xFU)
/**
  * @}
  */
