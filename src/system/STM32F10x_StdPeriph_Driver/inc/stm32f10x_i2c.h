...
#define I2C_EVENT_M_BYTE_TRANSMITTING                 ((uint32_t)0x00070080) /* TRA, BUSY, MSL, TXE flags */
/* --EV8_2 I2C_EVENT_MASTER_BYTE_TRANSMITTED*/
#define  I2C_EVENT_M_BYTE_TRANSMITTED                 ((uint32_t)0x00070084)  /* TRA, BUSY, MSL, TXE and BTF flags */
...
#define IS_I2C_EVENT(EVENT) (((EVENT) == I2C_EVENT_SLAVE_TRANSMITTER_ADDRESS_MATCHED) || \
                             ...
                             ((EVENT) == I2C_EVENT_M_BYTE_TRANSMITTED) || \
                             ((EVENT) == I2C_EVENT_M_BYTE_TRANSMITTING) || \
