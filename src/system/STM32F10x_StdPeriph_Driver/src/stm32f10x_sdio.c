...
void SDIO_DeInit(void)
{
  ...
  SDIO->CLKCR = 0x00000000U;
  SDIO->ARG = 0x00000000U;
  SDIO->CMD = 0x00000000U;
  SDIO->DTIMER = 0x00000000U;
  SDIO->DLEN = 0x00000000U;
  SDIO->DCTRL = 0x00000000U;
  SDIO->ICR = 0x00C007FFU;
  SDIO->MASK = 0x00000000U;
}
...
void SDIO_StructInit(SDIO_InitTypeDef* SDIO_InitStruct)
{
  ...
  SDIO_InitStruct->SDIO_ClockDiv = 0x00U;
...
void SDIO_CmdStructInit(SDIO_CmdInitTypeDef* SDIO_CmdInitStruct)
{
  ...
  SDIO_CmdInitStruct->SDIO_Argument = 0x00U;
  SDIO_CmdInitStruct->SDIO_CmdIndex = 0x00U;
