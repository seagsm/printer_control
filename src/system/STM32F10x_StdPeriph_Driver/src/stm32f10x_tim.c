...
void TIM_TimeBaseInit(TIM_TypeDef* TIMx, TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  if((TIMx != TIM6) && (TIMx != TIM7))
  {
    ...
    tmpcr1 |= (uint16_t)TIM_TimeBaseInitStruct->TIM_ClockDivision;/*HERE was error tmpcr1 |= should be uint16_t (uint32_t)TIM_TimeBaseInitStruct->TIM_ClockDivision;*/
  }
...
{
  uint16_t tmpccmrx = 0U, tmpccer = 0U, tmpcr2 = 0U;
...
void TIM_BDTRConfig(TIM_TypeDef* TIMx, TIM_BDTRInitTypeDef *TIM_BDTRInitStruct)
{
  ...
  u16_tmp = TIM_BDTRInitStruct->TIM_OSSRState | TIM_BDTRInitStruct->TIM_OSSIState;
  u16_tmp = u16_tmp | TIM_BDTRInitStruct->TIM_LOCKLevel;
  u16_tmp = u16_tmp | TIM_BDTRInitStruct->TIM_DeadTime;
  u16_tmp = u16_tmp | TIM_BDTRInitStruct->TIM_Break;
  u16_tmp = u16_tmp | TIM_BDTRInitStruct->TIM_BreakPolarity;
  TIMx->BDTR = u16_tmp | TIM_BDTRInitStruct->TIM_AutomaticOutput;
}
...
void TIM_TimeBaseStructInit(TIM_TimeBaseInitTypeDef* TIM_TimeBaseInitStruct)
{
  ...
  TIM_TimeBaseInitStruct->TIM_Period = 0xFFFFU;
  TIM_TimeBaseInitStruct->TIM_Prescaler = 0x0000U;
  TIM_TimeBaseInitStruct->TIM_ClockDivision = TIM_CKD_DIV1;
  TIM_TimeBaseInitStruct->TIM_CounterMode = TIM_CounterMode_Up;
  TIM_TimeBaseInitStruct->TIM_RepetitionCounter = 0x0000U;
}
...
void TIM_OCStructInit(TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  TIM_OCInitStruct->TIM_Pulse = 0x0000U;
...
void TIM_ICStructInit(TIM_ICInitTypeDef* TIM_ICInitStruct)
{
  ...
  TIM_ICInitStruct->TIM_ICFilter = 0x00U;
}
...
void TIM_SelectOCxM(TIM_TypeDef* TIMx, uint16_t TIM_Channel, uint16_t TIM_OCMode)
{
  ...
  {
    /*     tmp += (   ((uint16_t)TIM_Channel >> 1    ); */
    tmp += ((uint16_t)(TIM_Channel >> (uint16_t)1));
  ...
  else
  {
    ...
    tmp += (uint16_t)( (uint16_t)(TIM_Channel - (uint16_t)4) >> (uint16_t)1);
...
{
  ITStatus bitstatus = RESET;
  uint16_t itstatus = 0x0U, itenable = 0x0U;
  /* Check the parameters */
  assert_param(IS_TIM_ALL_PERIPH(TIMx));
