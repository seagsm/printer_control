 ...
 * @brief In the following line adjust the External High Speed oscillator (HSE) Startup
   Timeout value
   */
#define HSE_STARTUP_TIMEOUT   ((uint16_t)0x0500U) /*!< Time out for HSE start up */

#define HSI_VALUE    ((uint32_t)8000000) /*!< Value of the Internal oscillator in Hz*/

/**
 * @brief STM32F10x Standard Peripheral Library version number,STM32F10X_STDPERIPH_VERSION
   */
#define __VERSION_NUM_MAIN   (0x03) /*!< [31:24] main version */
#define __VERSION_NUM_SUB1   (0x05) /*!< [23:16] sub1 version */
#define __VERSION_NUM_SUB2   (0x00) /*!< [15:8]  sub2 version */
#define __VERSION_NUM_RC     (0x00) /*!< [7:0]  release candidate */
#define __VERSION_NUM       ( (__VERSION_NUM_MAIN << 24)\
                                             |(__VERSION_NUM_SUB1 << 16)\
                                             |(__VERSION_NUM_SUB2 << 8)\
                                             |(__VERSION_NUM_RC))
...
/*!< TIM2_REMAP configuration,AFIO_MAPR_TIM2_REMAP */
#define TIM2_REMAP_NOREMAP         ((uint32_t)0x00000000)        /*!< No remap (CH1/ETR/PA0, CH2/PA1, CH3/PA2, CH4/PA3) */
#define TIM2_REMAP_PARTIALREMAP1   ((uint32_t)0x00000100)        /*!< Partial remap (CH1/ETR/PA15, CH2/PB3, CH3/PA2, CH4/PA3) */
#define TIM2_REMAP_PARTIALREMAP2   ((uint32_t)0x00000200)        /*!< Partial remap (CH1/ETR/PA0, CH2/PA1, CH3/PB10, CH4/PB11) */
#define TIM2_REMAP_FULLREMAP       ((uint32_t)0x00000300)        /*!< Full remap (CH1/ETR/PA15, CH2/PB3, CH3/PB10, CH4/PB11) */
