...
static __I uint8_t AHBPrescTable[16] = {0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 1U, 2U, 3U, 4U, 6U, 7U, 8U, 9U};
/**
  * @}
  */
...
static void SetSysClockTo72(void)
{
  __IO uint32_t StartUpCounter = 0U, HSEStatus = 0U;
       uint32_t u32_a;
